...
class GUI:
    ...
    def __init__(self):
        ...
        self.lable_no_of_indoor_tiles = tk.Label(
            self.root, text=f"Indoor tiles: ")
        self.lable_no_of_indoor_tiles.pack()
        
        self.lable_no_of_outdoor_tiles = tk.Label(
            self.root, text=f"Outdoor tiles: ")
        self.lable_no_of_outdoor_tiles.pack()
    ...
    def update_indoor_tiles_count(self, count):
        self.lable_no_of_indoor_tiles.config(text=f"Indoor tiles: {count}")
        
    def update_outdoor_tiles_count(self, count):
        self.lable_no_of_outdoor_tiles.config(text=f"Outdoor tiles: {count}")
